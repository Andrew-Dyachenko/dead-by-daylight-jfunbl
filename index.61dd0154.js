...
const checkReducedMotionPreference = ()=>{
    ...
    for (const svgElement of svgElements){
        ...
        if (prefersReducedMotion) // Wrap each <animate> and <set> element in a <template>
        ...
        else // If the user does not prefer reduced motion, unwrap <template> elements
...
window.matchMedia("(prefers-reduced-motion: reduce)").addEventListener("change", checkReducedMotionPreference);

},{}]},["bB7Pu"], "bB7Pu", "parcelRequire94c2")

//# sourceMappingURL=index.61dd0154.js.map
